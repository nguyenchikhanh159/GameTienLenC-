...
namespace Server
{
    class Program
    {
        ...
        static List<Socket> socket_signalDel = new List<Socket>();// gửi tín hiệu xóa bài
        static List<Socket> socket_broadcastCard = new List<Socket>();//gửi bài vừa đánh
        static List<Socket> socket_broadcastStatusPlaying = new List<Socket>();// gửi tín hiệu ai đang đánh
        static List<Socket> socket_Rank = new List<Socket>();// gửi bản rank
        static List<Socket> socket_money = new List<Socket>();//gửi tiền
        static List<Socket> socket_port = new List<Socket>();//gửi port backup
        static List<ClsHandCards> client = new List<ClsHandCards>();// danh sách client trong sv
        static ClsRules rule = new ClsRules();//quản lý luật chơi
        static IPEndPoint ipe;
        static string _myIp;
        static List<phong> dsPhong = new List<phong>();//danh sách phòng chơi
