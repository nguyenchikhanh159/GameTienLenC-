...
namespace HienBai
{
    public partial class frmRoom : Form
    {
        ...
        public static List<ClsRank> Deserialize_Rank(byte[] buff)
        {
        ...
        public static List<ClsCard> Deserialize(byte[] buff)
        {
            MemoryStream stream = new MemoryStream(buff);
        ...
        public static byte[] Serialize(List<ClsCard> c)
        {        
        ...
        private void ListenToActivating()
        {
           while(true)
            {
                byte[] buff = new byte[1024];
        ...
        public void ListenToReciveBroadcast()
        {
            while (true)
            {
                try
        ...
        private void ListenToSigalOtherPlayerPlaying()
        {
            while (true)
            {
                try
        ...
        #endregion
        private void ShowCardOfBroadcast(List<ClsCard> broadcast_card)
        {
        ...
        private void ShowImageBackGround()
        {
            ...
            {
                Bitmap temp = new Bitmap(Application.StartupPath + "\\Resources\\" + "BG" + ".jpg");
        ...
        private void ClearCardBroadCast()
        {
        ...
        public void ShowCards(ClsHandCards clc)
        {
            for (int index = 0; index < ctrl.Count; index++)
            {
